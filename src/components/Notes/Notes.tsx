...
const Notes = ({ data }: any) => {
  ...
  <p>    {data.content}</p>
      <div className={`down-dash ${display ? "show" : ""}`}>
        <div>
          <PiBellSimpleZ title="coming soon..." size={22} color={color} />
        </div>
        <div>
          <IoMdPersonAdd title="coming soon..." size={22} color={color} />
        </div>
        ...
        <div>
          <BsThreeDotsVertical title="coming soon..." size={22} color={color} />
        </div>
      </div>
    </div>
  );
